...
export default function TendersPage() {
  ...
  const filteredTenders = tendersData.tenders.filter((tender) => {
    if (tendersData.tenders.length === 0) return false
  ...
  // Check if tenders array is empty
  const hasTenders = tendersData.tenders.length > 0
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          {hasTenders ? (
            ...
            // Display message when no tenders are available
            <div className="bg-background p-8 rounded-lg text-center mb-12 border border-border">
              <h3 className="text-xl font-bold mb-4">No tenders available at the moment.</h3>
              <p className="text-muted-foreground mb-6">Please check back later for new procurement opportunities.</p>
            </div>
          )}
