    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Industrial-scale hot-dip galvanizing providing superior long-term corrosion protection
            </motion.p>
          </div>
        </div>
      </motion.section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20" ref={overviewRef}>
            <motion.div initial="hidden" animate={overviewInView ? "visible" : "hidden"} variants={fadeInUp}>
              <h2 className="text-3xl font-bold mb-6">Superior Corrosion Protection</h2>
              <p className="text-lg text-muted-foreground mb-6">{galvanizingData.overview}</p>
              <motion.ul
                className="space-y-4"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" ref={qualityRef}>
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6">{galvanizingData.qualityAssurance.description}</p>
              <motion.ul
              ...
              >
                <Button asChild>
                  <Link href="/contact">Request a Galvanizing Quote</Link>
                </Button>
              </motion.div>
            </motion.div>
            <motion.div
      ...
      >
        <div className="px-4 text-center">
          <h2 className="text-3xl text-white font-bold mb-6">Expedited Galvanizing Services</h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto">{galvanizingData.emergencyServices}</p>
          <motion.div
