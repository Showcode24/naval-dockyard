...
export default function ServicePage({
  ...
  return (
    <div className="overflow-x-hidden">
      {/* Hero Section with Parallax Effect - Only shown if showHero is true and heroImage exists */}
      {showHero && data.heroImage && (
        <motion.div
          ref={heroRef}
        ...
        >
          ...
          >
            ...
            >
              {data.heroTitle || pageTitle || "Our Services"}
            </motion.h1>
            {data.heroSubtitle && (
              <motion.p
      ...
      {/* Page title if no hero section */}
      {(!showHero || !data.heroImage) && pageTitle && (
      ...
      <section ref={overviewRef} className="py-12 px-4">
        <div className="container mx-auto">
          ...
          <div className={`grid grid-cols-1 ${data.overviewImage ? "md:grid-cols-2" : ""} gap-8 items-center`}>
            <motion.div
              variants={fadeInUp}
              initial="hidden"
              animate={overviewInView ? "visible" : "hidden"}
              transition={{ duration: 0.6 }}
              className={!data.overviewImage ? "max-w-3xl mx-auto" : ""}
            >
      ...
      {/* Process Section with Sequential Animations - Only shown if showProcess is true and process data exists */}
      {showProcess && data.process && data.process.length > 0 && (
        <section ref={processRef} className="py-12 px-4">
          <div className="container mx-auto">
            ...
            <div className={`grid grid-cols-1 md:grid-cols-${Math.min(data.process.length, 4)} gap-6`}>
      ...
      {/* Quality Assurance Section - Only shown if showQuality is true and qualityAssurance data exists */}
      {showQuality && data.qualityAssurance && (
        <section ref={qualityRef} className="py-12 px-4">
          <div className="container mx-auto">
            ...
            <div className={`grid grid-cols-1 ${data.qualityImage ? "md:grid-cols-2" : ""} gap-8 items-center`}>
              {data.qualityImage && (
                <motion.div
                  initial={{ opacity: 0, x: -50 }}
              ...
              <motion.div
                ...
                transition={{ duration: 0.6 }}
                className={!data.qualityImage ? "max-w-3xl mx-auto" : ""}
              >
      ...
      {/* Emergency Services Section - Only shown if showEmergency is true and emergencyServices data exists */}
      {showEmergency && data.emergencyServices && (
